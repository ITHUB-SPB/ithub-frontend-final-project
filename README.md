...
- [] доработать компонент `Featured` (1 балл за стилизацию мобильной версии, 1 балл за подгрузку изображений, 1 балл за динамическое выставление стилей фона по свойствам из объектов, 3 балла за адаптив под десктоп)

- [] доработать компонент `Featured` получать товары с бэка (1 балл), реализовать рандомизацию получаемых товаров (1 балл)
...
- [] реализовать счетчики количества товаров на изменение количества и удаление (2 балла);
- [] реализовать форму оформления заказа (2 балла);
